...
@section('content')
    <div class="row">
                ...
                <div class="card-body">
                    ...
                    <div class="widget-chart-1">
                        <div class="widget-chart-box-1 float-start" dir="ltr">
                            <input id="knobInput" data-plugin="knob" data-width="70" data-height="70"
                                data-fgColor="#f05050 " data-bgColor="#F9B9B9" value="{{ $countsiswa ?? '' }}"
                    ...
                    <div class="widget-chart-1">
                        <div class="widget-chart-box-1 float-start" dir="ltr">
                            <input data-plugin="knob" data-width="70" data-height="70" data-fgColor="#ffbd4a"
                                data-bgColor="#FFE6BA" value="{{ $countTransaksi ?? '' }}" data-skin="tron"
        ...
        <div class="col-xl-7 col-md-6">
            <div class="card">
                <div class="card-body">
                    <form method="GET" action="{{ route('tk.admin.dashboard') }}">
                        <div class="row ">
                            <div class="col-md-2">
                                <P>Start - End</P>
                            </div>
                    ...
                    <div class="widget-box-2 mt-2">
                        <div class="widget-detail-2 text-end">
                            <span class="badge bg-success rounded-pill float-start mt-3">RP <i
                    ...
                    <div class="widget-box-2">
                        <div class="widget-detail-2 text-end">
                            ...
                            <h2 class="fw-normal mb-1">
                                {{ !empty($totalNominalBayarSMP) ? 'Rp ' . number_format($totalNominalBayarSMP, 0, ',', '.') : 'Rp 0' }}
                            </h2>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="widget-chart-1">
                        <div class="widget-chart-box-1 float-start" dir="ltr">
                            <input data-plugin="knob" data-width="70" data-height="70" data-fgColor="#ffbd4a"
                                data-bgColor="#FFE6BA" value="{{ $countTransaksispp ?? '' }}" data-skin="tron"
                                data-angleOffset="180" data-readOnly=true data-thickness=".15" />
                        </div>
                        <div class="widget-detail-1 text-end">
                            <h2 class="fw-normal pt-2 mb-1"> {{ $countTransaksispp ?? '' }} </h2>
                            <p class="text-muted mb-1">Jumlah Pembayaran spp</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="widget-chart-1">
                        <div class="widget-chart-box-1 float-start" dir="ltr">
                            <input data-plugin="knob" data-width="70" data-height="70" data-fgColor="#ffbd4a"
                                data-bgColor="#FFE6BA" value="{{ $countTransaksidu ?? '' }}" data-skin="tron"
                                data-angleOffset="180" data-readOnly=true data-thickness=".15" />
                        </div>
                        <div class="widget-detail-1 text-end">
                            <h2 class="fw-normal pt-2 mb-1"> {{ $countTransaksidu ?? '' }} </h2>
                            <p class="text-muted mb-1"> Jumlah Pembayaran DU</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="widget-chart-1">
                        <div class="widget-chart-box-1 float-start" dir="ltr">
                            <input data-plugin="knob" data-width="70" data-height="70" data-fgColor="#ffbd4a"
                                data-bgColor="#FFE6BA" value="{{ $countTransaksimutasi ?? '' }}" data-skin="tron"
                                data-angleOffset="180" data-readOnly=true data-thickness=".15" />
                        </div>
                        <div class="widget-detail-1 text-end">
                            <h2 class="fw-normal pt-2 mb-1"> {{ $countTransaksimutasi ?? '' }} </h2>
                            <p class="text-muted mb-1"> Jumlah Pembayaran Mutasi</p>
                        </div>
                    </div>
                </div>
            </div>
